...
<html lang="en">
    ...
    <body>
        ...
        <div id="barra" class="barra">
            <div class="btn-group">
                <button type="button" onclick="abrirPagina('assets/aula/nave_vg/aberturaVideo.html'); funcaoLog('Menu(MISSION)'); funcaoLog('Saiu_pagina'); pagina='aberturaVideo';" class="btn btn-primary">Início da missão</button>
            </div>
        ...
        <script>
            $(function(){
                abrirPagina('assets/aula/nave_vg/aberturaVideo.html');
            });
